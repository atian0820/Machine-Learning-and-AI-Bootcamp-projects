...
datasetPath = "/Users/alan/Desktop/MLCapstone/pcb_wacv_2019/"
xmlPath = None

formattedDatasetPath = "/Users/alan/Desktop/MLCapstone/pcb_wacv_2019_formatted/"
...
with open("/Users/alan/Desktop/MLCapstone/pcb_wacv_2019_formatted.csv", csvMode) as csvFile:
    for folder in os.listdir(datasetPath):
        ...
        for i in range(6,len(list(root))):
            ...
            if imgWriteEnable:
                ...
                os.makedirs(formattedDatasetPath+compName, exist_ok=True)
